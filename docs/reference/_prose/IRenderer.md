...
[slots and modules](/docs/surface/concepts/four-slots)) on the
[Surface](/docs/surface/contracts/surface) core. A
...
[ISurfaceView](/docs/surface/contracts/i-surface-view).
...
[write a renderer guide](/docs/surface/guides/write-a-renderer) for a worked
implementation.
...
[ISurfaceView](/docs/surface/contracts/i-surface-view) on `collection`, its
