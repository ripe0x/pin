---
contract: HoldsCollectionHook
slug: holds-collection-hook
deploymentsKey: holdsCollectionHook
...
No-op. HoldsCollectionHook gates on `beforeMint` alone and keeps no
per-mint record.
