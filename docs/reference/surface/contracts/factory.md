...
```solidity
function createSurfaceCustom(string name, string symbol, address owner, SurfaceConfig cfg, address[] initialMinters, address primaryMinter, address[] creators) external returns (address collection)
```
...
```solidity
function createPooledSurface(string name, string symbol, address owner, SurfaceConfig cfg, address[] initialMinters, address primaryMinter, address[] creators) external returns (address collection)
```
