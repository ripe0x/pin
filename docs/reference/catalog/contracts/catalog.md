...
`0x467a9c39e03C595EC3075D856f19C7386b6b915d` · [view on evm.now](https://evm.now/address/0x467a9c39e03C595EC3075D856f19C7386b6b915d?chainId=1) · Ethereum mainnet
...
cast call 0x467a9c39e03C595EC3075D856f19C7386b6b915d \
...
cast call 0x467a9c39e03C595EC3075D856f19C7386b6b915d "isContractRegistered(address,address)(bool)" \
...
```solidity
function addContractFor(address artist, address contractAddress) external
```
...
```solidity
function removeContractFor(address artist, address contractAddress) external
```
...
```solidity
function addToken(address contractAddress, uint256 tokenId) external
```
...
```solidity
function addTokenFor(address artist, address contractAddress, uint256 tokenId) external
```
...
```solidity
function removeTokenFor(address artist, address contractAddress, uint256 tokenId) external
```
...
```solidity
function addTokenRange(address contractAddress, uint256 startTokenId, uint256 endTokenId) external
```
...
```solidity
function addTokenRangeFor(address artist, address contractAddress, uint256 startTokenId, uint256 endTokenId) external
```
...
```solidity
function removeTokenRange(address contractAddress, uint256 startTokenId, uint256 endTokenId) external
```
...
```solidity
function removeTokenRangeFor(address artist, address contractAddress, uint256 startTokenId, uint256 endTokenId) external
```
...
```solidity
function getCatalogCountsOf(address artist) external view returns (uint256 contracts, uint256 tokens, uint256 tokenRanges)
```
...
```solidity
function getCatalogOf(address artist) external view returns (address[] contracts, Catalog.TokenPointer[] tokens, Catalog.TokenRangePointer[] tokenRanges)
```
...
```solidity
function getContractAt(address artist, uint256 index) external view returns (address)
```
...
```solidity
function getContractCount(address artist) external view returns (uint256)
```
...
```solidity
function getContractKey(address contractAddress) external pure returns (bytes32)
```
...
```solidity
function getContracts(address artist) external view returns (address[])
```
...
```solidity
function getContractsSlice(address artist, uint256 start, uint256 count) external view returns (address[])
```
...
```solidity
function getTokenAt(address artist, uint256 index) external view returns (address contractAddress, uint256 tokenId)
```
...
```solidity
function getTokenCount(address artist) external view returns (uint256)
```
...
```solidity
function getTokenKey(address contractAddress, uint256 tokenId) external pure returns (bytes32)
```
...
```solidity
function getTokenRangeAt(address artist, uint256 index) external view returns (address contractAddress, uint256 startTokenId, uint256 endTokenId)
```
...
```solidity
function getTokenRangeCount(address artist) external view returns (uint256)
```
...
```solidity
function getTokenRangeKey(address contractAddress, uint256 startTokenId, uint256 endTokenId) external pure returns (bytes32)
```
...
```solidity
function getTokenRanges(address artist) external view returns (Catalog.TokenRangePointer[])
```
...
```solidity
function getTokenRangesSlice(address artist, uint256 start, uint256 count) external view returns (Catalog.TokenRangePointer[])
```
...
```solidity
function getTokens(address artist) external view returns (Catalog.TokenPointer[])
```
...
```solidity
function getTokensSlice(address artist, uint256 start, uint256 count) external view returns (Catalog.TokenPointer[])
```
...
```solidity
function isContractRegistered(address artist, address contractAddress) external view returns (bool)
```
...
### isTokenRangeRegistered

```solidity
function isTokenRangeRegistered(address artist, address contractAddress, uint256 startTokenId, uint256 endTokenId) external view returns (bool)
```
...
```solidity
function isTokenRegistered(address artist, address contractAddress, uint256 tokenId) external view returns (bool)
```
...
```solidity
event ContractAdded(address indexed artist, address indexed actor, address indexed contractAddress)
```
...
```solidity
event ContractRemoved(address indexed artist, address indexed actor, address indexed contractAddress)
```
...
```solidity
event OperatorSet(address indexed artist, address indexed operator, bool approved)
```
...
```solidity
event TokenAdded(address indexed artist, address indexed actor, address indexed contractAddress, uint256 tokenId)
```
...
```solidity
event TokenRangeAdded(address indexed artist, address indexed actor, address indexed contractAddress, uint256 startTokenId, uint256 endTokenId)
```
...
```solidity
event TokenRangeRemoved(address indexed artist, address indexed actor, address indexed contractAddress, uint256 startTokenId, uint256 endTokenId)
```
...
```solidity
event TokenRemoved(address indexed artist, address indexed actor, address indexed contractAddress, uint256 tokenId)
```
