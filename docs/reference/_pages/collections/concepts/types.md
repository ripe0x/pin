...
See [Id modes](/docs/collections/concepts/id-modes) for the full behavioral
detail.
...
[Injection convention](/docs/collections/reference/injection-convention) for
...
See [Seed and provenance](/docs/collections/concepts/mint-marks-and-entropy)
