...
| `/abis/<ContractName>.json` | the raw ABI array for each contract, e.g. `/abis/Collection.json` |
    ...
    "collections": {
      ...
      "contracts": {
        "Collection": {
          "address": null,
          "kind": "clone",
          "abi": "/abis/Collection.json",
          "docs": "/docs/collections/contracts/collection",
          "role": "The one core of the PND Collection System..."
        },
        "CollectionFactory": {
          "address": "{{addr:collectionFactory}}",
          "kind": "singleton",
          "abi": "/abis/CollectionFactory.json",
          "docs": "/docs/collections/contracts/factory",
          "role": "Deploys and configures Collection clones"
        }
      }
    },
    "auctions": {
...
Fetch any of these directly, e.g. `/abis/Collection.json`, or import the typed version from the npm workspace package.
...
const entry = manifest.protocols.collections.contracts.CollectionFactory;
