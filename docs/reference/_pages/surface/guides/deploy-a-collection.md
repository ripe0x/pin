...
[FixedPriceMinter](/docs/surface/contracts/fixed-price-minter) bound to it,
...
[RenderAssets](/docs/surface/contracts/render-assets). Nothing about either
clone's code changes; only its slot pointers and stored config do. See:

- [Slots and modules](/docs/surface/concepts/four-slots) for the renderer
  slot, the minter, and the price-strategy slot
- [Mint](/docs/surface/guides/mint) for minting through the canonical
  minter
- [Write a minter](/docs/surface/guides/write-a-minter) for pooled or
  economics-carrying collections
- [Surface](/docs/surface/contracts/surface),
  [SurfaceFactory](/docs/surface/contracts/factory), and
