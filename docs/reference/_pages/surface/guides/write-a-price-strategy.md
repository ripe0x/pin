...
[FixedPriceMinter](/docs/surface/contracts/fixed-price-minter), the one
...
[ISurfaceView](/docs/surface/contracts/i-surface-view), companion contracts
...
`withdraw`. See [Mint](/docs/surface/guides/mint) for the full
...
See [IPriceStrategy](/docs/surface/contracts/i-price-strategy) for the
generated interface reference, and
[Slots and modules](/docs/surface/concepts/four-slots) for how this slot
