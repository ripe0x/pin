...
- [Collections](/docs/collections/overview): artist-owned ERC721 collections
  ...
  extension minter), per-token Mint Marks and entropy, and a directed Release
  Graph and Token Path. Editions, generative drops, onchain SVG works, and
  backed or redeemable works are all the same core with different modules
