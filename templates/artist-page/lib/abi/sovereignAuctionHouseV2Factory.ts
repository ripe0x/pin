// Auto-extracted from contracts/out/SovereignAuctionHouseV2Factory.sol/SovereignAuctionHouseV2Factory.json.
// Re-run: node scripts/emit-sovereign-abi.mjs
export const sovereignAuctionHouseV2FactoryAbi = [
  {
    "type": "constructor",
    "inputs": [
      {
