...
/**
 * Previous landing page: a reverse-chronological stream of sovereign actions
 * (deploy, list, mint, settle), with the artist as the subject of every row.
 * No platform-style work grid. Kept reachable at `/index-prev`; the
 * discovery-led landing at `/` is the current default.
 */
