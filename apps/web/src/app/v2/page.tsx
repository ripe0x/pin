...
/**
 * Landing page concept v2 — a reverse-chronological stream of sovereign
 * actions (deploy, list, mint, settle), with the artist as the subject of
 * every row. No platform-style work grid; the page leads with what artists
 * are doing on their own infrastructure rather than what's currently for
 * sale.
 */
