...
// Availability and activity read live production data; keep the shell
// dynamic so a stale build artifact never freezes them.
      ...
      <div className="grid gap-14 lg:grid-cols-[minmax(0,1.45fr)_minmax(260px,0.55fr)] lg:items-start">
        ...
        <aside className="space-y-8 lg:sticky lg:top-24">
          ...
          <div className="space-y-3 border-t border-gray-200 pt-7">
            ...
            <Link href="/auctions" className="inline-block text-xs font-mono underline underline-offset-4">
              Open auctions
            </Link>
          </div>
        </aside>
