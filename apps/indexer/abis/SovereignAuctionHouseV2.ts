// Auto-extracted from contracts/out/SovereignAuctionHouseV2.sol/SovereignAuctionHouseV2.json.
// Re-run: node scripts/emit-sovereign-abi.mjs
export const sovereignAuctionHouseV2Abi = [
  {
    "type": "constructor",
    "inputs": [],
  ...
  {
    "type": "function",
    "name": "bulkCreateAuctionsWithSettings",
    "inputs": [
      {
        "name": "tokenContract",
        "type": "address",
      ...
      },
      {
        "name": "lots",
        "type": "tuple[]",
        "internalType": "struct ISovereignAuctionHouseV2.BulkLot[]",
        "components": [
          {
            "name": "tokenId",
            "type": "uint256",
  ...
  {
    "type": "event",
    "name": "AuctionFundsRecipientUpdated",
    "inputs": [
      {
        "name": "auctionId",
        "type": "uint256",
  ...
  {
    "type": "event",
    "name": "AuctionListingExpiryUpdated",
    "inputs": [
      {
        "name": "auctionId",
        "type": "uint256",
  ...
  {
    "type": "error",
    "name": "EscrowedDeliveryDoesNotExist",
    "inputs": []
  },
  {
    "type": "error",
