...
-- never belong in Postgres. `collection_media` (migration 025) is still
-- written by the capture-collection-media worker task for Surface SVG
-- captures; the columns added below give it the same delivery shape.
