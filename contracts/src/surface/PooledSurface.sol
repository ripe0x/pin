...
///         token id mirrors an external source id: one authorized minter at a
///         time chooses every id and is the only address that can burn;
///         lockMinter makes that minter permanent. A burned id can be minted
///         again as a new instance with a fresh seed. No built-in mint
///         economics; minting goes through the minter.
