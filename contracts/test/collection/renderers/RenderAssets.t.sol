...
contract RenderAssetsTest is Test {
    ...
    function setUp() public {
        ...
        collection = Collection(
            factory.createCollection("Assets Test", "AT", artist, cfg, new address[](0), new address[](0))
        );
        vm.prank(artist);
    ...
    function test_capturer_grantIsPerCollection() public {
        ...
        Collection other;
        {
            ...
            CollectionConfig memory cfg;
            other = Collection(
                factory.createCollection("Other", "OTH", artist, cfg, new address[](0), new address[](0))
            );
        }
        vm.prank(artist);
