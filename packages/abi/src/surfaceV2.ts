// Auto-extracted from contracts/out/SurfaceV2.sol/SurfaceV2.json.
// Re-run: node scripts/emit-surface-abi.mjs
export const surfaceV2Abi = [
  {
    "type": "constructor",
    "inputs": [],
    ...
    "inputs": [
      {
        "name": "p",
        "type": "tuple",
        "internalType": "struct InitParamsV2",
        "components": [
          {
            "name": "name",
            "type": "string",
