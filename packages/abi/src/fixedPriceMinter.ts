// Auto-extracted from contracts/out/FixedPriceMinter.sol/FixedPriceMinter.json.
// Re-run: node scripts/emit-surface-abi.mjs
export const fixedPriceMinterAbi = [
  {
    "type": "constructor",
    "inputs": [],
    ...
    "inputs": [
      {
        "name": "p",
        "type": "tuple",
        "internalType": "struct FixedPriceMinterInitParams",
        "components": [
          {
            "name": "collection",
            "type": "address",
